            ...
            get
            {
                switch (AuthVM.Lang)
                {
                    case "ru-RU":
                        ...
                        break;
                    case "fr-FR":
                        addWndTitle = "Nouvelle réservation";
                        break;
                }
                return addWndTitle;
            }
            ...
            get
            {
                switch (AuthVM.Lang)
                {
                    case "ru-RU":
                        ...
                        break;
                    case "fr-FR":
                        editWndTitle = "Modifier les données d'armure";
                        break;
                }
                return editWndTitle;
            }
            ...
            get
            {
                switch (AuthVM.Lang)
                {
                    case "ru-RU":
                        ...
                        break;
                    case "fr-FR":
                        saveBtnTitle = "Enregistrer les modifications";
                        break;
                }
                return saveBtnTitle;
            }
            ...
            if (!isIntersect)
            {
                ...
                switch (AuthVM.Lang)
                {
                    case "ru-RU":
                        ...
                        break;
                    case "fr-FR":
                        MessageBox.Show("La réservation a été créée avec succès. Vous pouvez fermer cette fenêtre", "Avec succès!", MessageBoxButton.OK, MessageBoxImage.Asterisk);
                        break;
                }
            }
            else switch (AuthVM.Lang)
                {
                    case "ru-RU":
                        ...
                        break;
                    case "fr-FR":
                        MessageBox.Show("Ce temps déjà pris!", "Erreur!", MessageBoxButton.OK, MessageBoxImage.Error);
                        break;
                }
        }
            ...
            if (!isIntersect)
            {
                ...
                switch (AuthVM.Lang)
                {
                    case "ru-RU":
                        ...
                        break;
                    case "fr-FR":
                        MessageBox.Show("La réservation a été modifiée avec succès. Vous pouvez fermer cette fenêtre", "Avec succès!", MessageBoxButton.OK, MessageBoxImage.Asterisk);
                        break;
                }
            }
            else switch (AuthVM.Lang)
                {
                    case "ru-RU":
                        ...
                        break;
                    case "fr-FR":
                        MessageBox.Show("Ce temps est occupé!", "Erreur!", MessageBoxButton.OK, MessageBoxImage.Error);
                        break;
                }
        }
        public void _DeleteReservation()
        {
            ...
            switch (AuthVM.Lang)
            {
                case "ru-RU":
                    ...
                    break;
                case "fr-FR":
                    result = MessageBox.Show("Êtes-vous sûr?", "Attention", MessageBoxButton.YesNo, MessageBoxImage.Question);
                    break;
            }
            if (result == MessageBoxResult.Yes)
            {
                ...
                switch (AuthVM.Lang)
                {
                    case "ru-RU":
                        ...
                        break;
                    case "fr-FR":
                        MessageBox.Show("La réservation a été supprimée avec succès. Vous pouvez fermer cette fenêtre", "Avec succès!", MessageBoxButton.OK, MessageBoxImage.Asterisk);
                        break;
                }
            }
        }
